...
public class TestApp extends PluginDevApplication {
    ...
    protected void startup() {
        ...
        try {
            ...
            //httpFile.setNewURL(new URL("https://cloud.mail.ru/public/7U3x/yfAbTmxcB"));
            httpFile.setNewURL(new URL("https://cloud.mail.ru/public/7U3x/yfAbTmxcB/HDRip.720p"));
            //httpFile.setNewURL(new URL("https://cloud.mail.ru/public/7U3x/yfAbTmxcB/BDRip.1080p/"));
            //httpFile.setNewURL(new URL("https://cloud.mail.ru/public/7U3x/yfAbTmxcB/BDRip.1080p/Der.kommer.en.dag.2016.BDRip.1080p.part2.rar"));
