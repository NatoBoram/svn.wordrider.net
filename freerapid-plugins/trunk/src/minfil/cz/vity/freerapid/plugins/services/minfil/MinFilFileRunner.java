 ...
 * @author birchie
 */
class MinFilFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(MinFilFileRunner.class.getName());
    ...
    public void run() throws Exception {
        ...
        if (makeRedirectedRequest(method)) { //we make the main request
            ...
            final HttpMethod httpMethod = getMethodBuilder().setReferer(fileURL)
                    .setActionFromAHrefWhereATagContains("img/file").toHttpMethod();
    ...
    private void checkProblems() throws ErrorDuringDownloadingException {
        ...
        if (contentAsString.contains("<title>404 ") || contentAsString.contains("Filen du söker ")) {
